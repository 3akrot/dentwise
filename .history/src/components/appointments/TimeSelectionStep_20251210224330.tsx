  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h2 className="text-2xl font-semibold">اختر التاريخ والوقت</h2>
      </div>

      <div className="grid lg:grid-cols-2 gap-8">
        {/* appointment type selection */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium">نوع الموعد</h3>
        ...
        {/* date & time selection */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium">التواريخ المتاحة</h3>
          ...
          {selectedDate && (
            <div className="space-y-3">
              <h4 className="font-medium">الأوقات المتاحة</h4>
      ...
      {selectedType && selectedDate && selectedTime && (
        <div className="flex justify-end">
          <Button onClick={onContinue}>مراجعة الحجز</Button>
        </div>
      )}
    </div>
  );
