  ...
  if (isLoading)
    return (
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold">اختر طبيب الأسنان</h2>
        <DoctorCardsLoading />
      </div>
    );
    ...
    <div className="space-y-6">
          ...
          >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="text-primary font-medium">
                    {dentist.speciality || "طب أسنان عام"}
                  </CardDescription>
            ...
            <CardContent className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                {dentist.bio || "متخصص أسنان ذو خبرة يقدم رعاية عالية الجودة."}
              </p>
              <Badge variant="secondary">متخصص معتمد</Badge>
            </CardContent>
          </Card>
        ))}
      </div>
      ...
      {selectedDentistId && (
        <div className="flex justify-end">
          <Button onClick={onContinue}>المتابعة لاختيار الوقت</Button>
        </div>
      )}
    </div>
  );
