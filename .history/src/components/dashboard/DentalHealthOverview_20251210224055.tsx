  ...
  return (
    <Card className="lg:col-span-2">
      <CardHeader>
        ...
        <CardDescription>تتبع رحلة رعاية أسنانك</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            ...
            <div className="text-sm text-muted-foreground">الزيارات المكتملة</div>
          </div>
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            <div className="text-2xl font-bold text-primary mb-1">
          ...
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            ...
            <div className="text-sm text-muted-foreground">عضو منذ</div>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl border border-primary/20">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-primary mb-1">هل أنت جاهز للبدء؟</h4>
              <p className="text-sm text-muted-foreground mb-3">
                احجز موعدك الأول أو جرب مساعدنا الصوتي AI للحصول على نصائح أسنان فورية.
              </p>
