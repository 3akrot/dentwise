              ...
              <div className="space-y-6">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm">
                  ...
                  <span className="text-sm font-medium text-primary">
                    مساعد أسنان ذكي بالذكاء الاصطناعي
                  </span>
                </div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  تحدث مع مساعدنا الذكي للحصول على نصائح فورية، احجز مواعيد ذكية، واحصل على
                  توصيات رعاية مخصصة. متاح على مدار الساعة.
                </p>
              </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      موثوق من{" "}
                      <span className="font-semibold text-foreground">+1,200 مريض</span>
                    </p>
                  </div>
                </div>
              </div>
