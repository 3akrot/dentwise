      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6">
            ...
            <span className="text-sm font-medium text-primary">محادثات مدعومة بالذكاء الاصطناعي</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            من الأسئلة البسيطة إلى المخاوف المعقدة، ذكاؤنا الاصطناعي يقدم إرشادات بمستوى الخبراء
            مدربة على آلاف حالات الأسنان الحقيقية
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold mb-8">أسئلة شائعة يجيب عليها ذكاؤنا الاصطناعي:</h3>
                    ...
                    <div className="space-y-3 flex-1">
                      <div className="bg-primary/5 rounded-2xl p-4 border border-primary/10">
                        <p className="font-semibold text-primary">
                          "سني يؤلمني عندما أعض"
                        </p>
                      </div>
                      <div className="bg-muted/30 rounded-2xl p-4">
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          احصل على نصائح فورية حول تخفيف الألم والأسباب المحتملة ومتى يجب زيارة
                          طبيب الأسنان بشكل عاجل
                        </p>
                ...
                <div className="bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-3 flex-1">
                      ...
                      <div className="bg-muted/30 rounded-2xl p-4">
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          قارن بين خيارات العلاج ونطاقات الأسعار واعثر على أفضل حل تبييض
                          يناسب ميزانيتك
                        </p>
                        <div className="flex gap-2 mt-3">
                          <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">
                ...
                <div className="bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-3 flex-1">
                      <div className="bg-primary/5 rounded-2xl p-4 border border-primary/10">
                        <p className="font-semibold text-primary">
                          "متى يجب أن أستبدل الحشوة؟"
                        </p>
                      </div>
                      <div className="bg-muted/30 rounded-2xl p-4">
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          تعرف على عمر الحشوة وعلامات التآكل التحذيرية وإرشادات توقيت الاستبدال
                        </p>
                        <div className="flex gap-2 mt-3">
                          <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">
                            رعاية وقائية
