          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10">
                ...
                <span className="text-xs font-medium text-primary">جاهزون عندما تحتاجنا</span>
              </div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                انضم إلى أكثر من 1,200 مريض يثقون في ذكائنا الاصطناعي للحصول على إرشادات فورية ورعاية مخصصة.
              </p>
            </div>
