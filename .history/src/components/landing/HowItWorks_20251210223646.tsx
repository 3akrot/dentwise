    ...
    <section className="relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-20">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6">
          ...
          <span className="text-sm font-medium text-primary">عملية بسيطة</span>
        </div>
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          عمليتنا المبسطة تجعل رعاية الأسنان سهلة ومريحة وخالية من التوتر للجميع
        </p>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <div className="w-20 h-20 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 mb-6">
                <Image src="/audio.png" alt="محادثة صوتية" width={40} height={40} className="w-14" />
              </div>

              <h3 className="text-2xl font-bold mb-4 text-center">اسأل أسئلتك</h3>
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                تحدث مع مساعدنا الذكي عن أي مخاوف تتعلق بالأسنان. احصل على إجابات فورية حول
                الأعراض والعلاجات ونصائح صحة الفم.
              </p>
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              {/* Icon */}
              <div className="w-20 h-20 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 mb-6">
                <Image src="/brain.png" alt="الذكاء الاصطناعي" width={40} height={40} className="w-14" />
              </div>

              <h3 className="text-2xl font-bold mb-4 text-center">احصل على نصائح الخبراء</h3>
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                احصل على توصيات مخصصة بناءً على آلاف حالات الأسنان. ذكاؤنا الاصطناعي
                يقدم رؤى بمستوى احترافي.
              </p>
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              {/* Icon */}
              <div className="w-20 h-20 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 mb-6">
                <Image src="/calendar.png" alt="تقويم" width={40} height={40} className="w-14" />
              </div>

              <h3 className="text-2xl font-bold mb-4 text-center">احجز واحصل على الرعاية</h3>
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                حدد موعداً مع أطباء أسنان معتمدين واحصل على متابعة شاملة. تتبع تقدمك
                بسهولة.
              </p>
