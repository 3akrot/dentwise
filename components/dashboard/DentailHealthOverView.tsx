import { getAppointments, getStatus } from "@/lib/actions/appointments";
...
export async function DentalHealthOverview() {
  const appointmentStats = await getStatus();
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            <div className="text-2xl font-bold text-primary mb-1">
              {appointmentStats.totalAppoinment}
            </div>
            <div className="text-sm text-muted-foreground">Completed Visits</div>
          </div>
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            <div className="text-2xl font-bold text-primary mb-1">
              {appointmentStats.completedAppoinments}
            </div>
