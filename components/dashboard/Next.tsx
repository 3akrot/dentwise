...
async function Next() {
  ...
  if (!nextAppointment) return <NoNext />; // no appointments, return nothing

  const appointmentDate = parseISO(nextAppointment.date.toString());
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-sm">{nextAppointment.doctor.name}</p>
